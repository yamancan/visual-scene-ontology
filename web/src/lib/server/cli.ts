...
// The pure pyshacl report parsers live in $lib/validate/report (no Node
// deps); re-exported here so this module's public surface is unchanged.
export { localName, parseViolationReport, type ParsedViolation } from '../validate/report';
